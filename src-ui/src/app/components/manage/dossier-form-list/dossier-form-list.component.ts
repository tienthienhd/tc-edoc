...
@Component({
  ...
  templateUrl:
    './../custom-dossier-form-list/custom-dossier-form-list.component.html',
  styleUrls: [
    './../custom-dossier-form-list/custom-dossier-form-list.component.scss',
  ],
})
export class DossiersFormComponent extends CustomDossierFormListComponent<DossierForm> {
  // id: number;
